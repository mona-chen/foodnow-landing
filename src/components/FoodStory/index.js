...
import "./foodStory.css";

const FoodStory = () => {
  return (
    <div className="food-story flex absolute-center">
      <div className="max-width flex story-wrapper">
        <div className="flex food-story-heading-wrapper">
          <div className="food-story-heading">
            the story of food begins with trust.
          </div>
        </div>
        <div className="food-story-detail">
          <div className="food-story-para">
          ...
          <div className="food-story-para">
            if you make it to food, congratulations and welcome. we have a lot
